...
const url = "https://www.jacintoimoveis.com.br/imoveis?pretensao=alugar&tipo=23&bairro=&valor_max=1.300";
const db = require("./db");
const url_base = "jacintoimoveis.com.br";
    ...
    while(true){
        ...
        try{
            ...
            while(prox && avancar > 0){
                ...
                avancar--;
                try{
                    let proxima = $(".pagination a:last").attr('href');
