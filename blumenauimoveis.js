...
const url = "https://www.blumenauimoveis.com.br/imoveis?pretensao=alugar&tipos=23&cidade=4202404&bairros=&valor_max=1.300";
const db = require("./db");
const url_base = "blumenauimoveis.com.br";
        ...
        try{
            ...
            while(prox && avancar > 0){
                ...
                for(let link of links) {
                    ...
                    if(href != undefined){
                        href = "https://www.blumenauimoveis.com.br" + href;
                        cont++;
                        try{
                            let existe = false;
                            for(let d of dados){
                ...
                try{
                    ...
                    response = await axios("https:"+$(proxima).attr('href') + "&timestamp=" + Date.now()).catch((err) => console.log(err));
                }catch{
                    prox = false;
                }
