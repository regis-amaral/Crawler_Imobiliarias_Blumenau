...
const url = "https://www.shsimoveis.com/imoveis/para-alugar/casa?preco-de-locacao=+1300";
const db = require("./db");
const url_base = "shsimoveis.com";
    ...
    while(true){
        ...
        try{
            ...
            while(prox && avancar > 0){
                ...
                let links = $('.listing-results .card > a');
                ...
                for(let link of links) {
                    ...
                    if(href != undefined){
                        cont++;
                        try{
                            href = "https://www.shsimoveis.com"+href;
                            let existe = false;
                            for(let d of dados){
                                if(d.link == href){
                                    existe = true;
                ...
                try{
                    ...
                    if(proxima != undefined){
                        response = await axios("https://www.shsimoveis.com" + proxima + "&timestamp=" + Date.now());
                    }
                }catch(e){
                    //console.log(e);
                    prox = false;
